...
Inherits all items from [base_checklist.md](base_checklist.md). Apply base items before these persona-specific ones.
...
- [ ] **QUALITY** Values & Priorities are distinct — no overlap or inversion of each other
...
A persona passes compliance if all base CRITICAL items and all persona-specific CRITICAL items pass. A beautifully simple persona also passes all QUALITY items.
