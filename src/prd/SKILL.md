---
name: prd
description: Formats information into a Product Requirements Document. Use when you need to produce a structured PRD from problem statements, requirements, and solution concepts.
metadata:
  category: load
---
