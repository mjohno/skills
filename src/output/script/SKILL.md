---
name: script
description: Produces well-defined, production-quality Python scripts from natural language descriptions — with proper structure, error handling, logging, input validation, dry-run support, and tests (stdlib only).
metadata:
  category: output
  capabilities:
    - script_generation
