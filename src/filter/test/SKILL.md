---
name: test
description: Filters prototypes and solutions by evaluating them against requirements and hypotheses with pass/fail scoring.
metadata:
  category: filter
  capabilities:
...
Goal: Filter solutions by evaluating prototypes against requirements and hypotheses to determine pass/partial/fail status.
