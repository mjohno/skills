---
name: collect
description: Retrieves resources, landscape scans, and competitive data from multiple sources into a structured resource inventory. Use when you need to collect information from the web, repos, or docs.
metadata:
  category: input
  capabilities:
    - resource_retrieval
...
Goal: Retrieve resources, landscape scan, and competitive data from multiple sources into a structured resource inventory.
