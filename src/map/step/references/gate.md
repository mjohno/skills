...
**Next mandatory phase:** After successful `approve`, proceed to [`execute.md`](execute.md). If the gate is terminal (`next_steps: []` and `recommendation: null`), accept exact `approved` or `break` and stop.
